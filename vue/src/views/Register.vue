<template>
  <div class="wrapper">
    <div style="margin:100px auto; background-color: #ffffff;width: 350px ;height:400px ; padding: 20px;border: 20px;border-radius: 10px">
  ...
  methods:{
    login() {
      this.$refs['userForm'].validate((valid) => {
        if (valid) {  // 表单校验合法
          if(this.user.padding !== this.user.confirmPassword){
